...
class ThreatModelDataModel(Model):
    """
    DynamoDB data model que represents threat model entities para persistence layer usando PynamoDB ORM.
    """
    class Meta:
...
class DiagramDataModel(Model):
    """
    DynamoDB data model que represents diagram entities com threat model relationships para data storage.
    """
    class Meta:
...
class ComponentDataModel(Model):
    """
    DynamoDB data model que represents component entities with diagram relationships para component persistence.
    """
    class Meta:
...
class ThreatDataModel(Model):
    """
    DynamoDB data model que represents threat entities with component relationships para threat storage.
    """
    class Meta:
