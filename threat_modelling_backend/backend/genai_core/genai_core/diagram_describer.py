...
@llm_metrics
def describe_diagram(image: bytes, model_id: ConverseModelIds = ConverseModelIds.CLAUDE_V4_5_SONNET_MODEL_ID,
                     user_description: str = "") -> ConverseResponseTypeDef:
    """
    Describes architecture diagrams using AI models que analyzes components and data flows 
    para create detailed threat modeling descriptions com few-shot examples.
    """
...
def get_diagram_description(image: bytes, model_id: str, user_description: str = ""):
    """
    Wrapper function que processes diagram description requests with string model ID 
    e returns formatted text output para threat modeling analysis.
    """
