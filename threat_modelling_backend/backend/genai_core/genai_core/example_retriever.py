...
class Example(BaseModel):
    """
    Example model que contains image bytes and diagram description 
    para few-shot learning em AI model training.
    """
    image_bytes: bytes
...
class ExampleRetriever:
    """
    S3-based example retriever que manages few-shot learning examples 
    para AI model training usando diagram images e descriptions.
    """
