...
def generate_threats(image: bytes, diagram_description: str, dataflow_component: DFDComponent,
                     ...
                     iterations: int = 2,
                     model_id: ConverseModelIds = ConverseModelIds.CLAUDE_V4_5_SONNET_MODEL_ID) -> Threats:
    """
    ...
    system_prompt = (
        ...
        f"You should provide an big list of {20} threats that may affect this component. "
...
Please give me an big list of {20} threats that may affect this component:
...
def get_threats_for_component(image: bytes,
    ...
    model_id = model_id or ConverseModelIds.CLAUDE_V4_5_SONNET_MODEL_ID.value
