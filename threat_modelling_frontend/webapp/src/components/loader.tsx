...
interface LoaderProps {
  /**
   * TypeScript interface que defines contract structure para type safety e API definitions.
   */
  message: string;
  className?: string;
}
...
export interface ISVGProps extends React.SVGProps<SVGSVGElement> {
  /**
   * Interface definition que defines type structure para TypeScript type safety e code documentation.
   */
  size?: number;
  className?: string;
}
