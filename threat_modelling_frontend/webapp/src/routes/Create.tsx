...
export type Component = {
  /**
   * Component type definition que represents architecture component structure 
   * para threat modeling project creation workflow.
   */
  id: string;
  name: string;
  description: string;
...
export default function Create() {
  /**
   * Create project component que handles multi-step threat modeling project creation 
   * with diagram upload, description e component management workflow.
   */
