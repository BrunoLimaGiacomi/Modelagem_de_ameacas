...
const getDiagram = async (client: any, modelId: string) => {
  /**
   * Fetches diagram data from GraphQL API que retrieves complete diagram information 
   * including components e threats para threat modeling workflow.
   */
...
enum ActionReasonPrompt {
  /**
   * Action reason prompts que define user-friendly messages 
   * para different threat mitigation actions em threat modeling workflow.
   */
...
const Flow: React.FC = () => {
  /**
   * Main threat modeling flow component que handles diagram analysis, component extraction 
   * e threat generation workflow usando AWS Amplify e GraphQL subscriptions.
   */
